...
- author_font, author_size, author_weigth, author_color
- title_font, title_size, title_weigth, title_color
- journal_font, journal_size, journal_weigth, journal_color
...
**Note:** Similarly incorrect CSS options do not throw any errors, but may result in unexpected behaviour / styling, mostly falling back to defaults. Please check, whether your custom options work on single bibliography items before bulk-styling many.
